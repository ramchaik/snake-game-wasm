import { rnd } from './snippets/snake-game-wasm-ee310914afedd220/www/utils/rnd.js';
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('snake_game_wasm_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_rnd_1e87346ca54f366d = function(arg0) {
        var ret = rnd(arg0 >>> 0);
        return ret;
    };
